...
?>
<p><?= $errors['empty'] ?? '' ?></p>
<form class="row g-3" action="<?php echo $this->getUrl('products', 'saveForm') ?>" method="POST">
    <div class="col-md-6">
    ...
    <div class="col-12">
        ...
        <input type="number" name="discount" value="<?= $discount ?? '' ?>" class=" form-control" id="discount">
    </div>
    <div class="col-12">
